...
삼성전자는 이날 실적 발표 컨퍼런스콜에서 "구글과의 확고한 파트너십을 바탕으로 갤럭시 AI를 최적화하여 사용자의 맥락을 이해하고 작업을 자동화하며 선제적으로 제안하는 에이전틱 AI로 발전시켜 나가겠다"고 말했다.


또 "특히 사용자 경험에 대한 깊이 있는 분석과 이해를 바탕으로 퍼스널 데이터 엔진에 기반한 개인화 경험을 강화하고, 모바일 웨어러블뿐만 아니라 TV 가전 등 당사의 방대한 기기 생태계를 활용해 라이프스타일 전반의 AI 경험을 고도화해 나갈 계획"이라고 강조했다.
