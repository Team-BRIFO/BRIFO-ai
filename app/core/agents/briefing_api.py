...
from app.schemas.briefing import AgentBriefing, RecentDecision


async def generate_briefing(
    news: dict,  # BE가 전달한 카드뉴스
    agent_type: str,  # "ROOKIE" | "TANKER" | "PRO"
...
async def generate_personal_comment(
    ...
    briefing_id: str,
    agent_type: str,
    briefing_conclusion: dict,  # {headline, direction, probability}
